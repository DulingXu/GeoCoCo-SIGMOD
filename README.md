...
This is the repo for our submited SIGMOD'2026 paper "Performant Synchronization in Geo-Distributed Databases".
GeoCoCo is built on top of GeoGauss, which is a strongly consistent OLTP database with full replica multi-master architecture.
